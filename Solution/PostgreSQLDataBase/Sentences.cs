...
namespace SqlDataBasePG
{
    ...
    public class Sentences
    {
        ...
        */
        ...
        private static DataSet FillDataSet(NpgsqlDataAdapter dAd)
        {
        ...
        private static DataSet FillDataSet(NpgsqlDataAdapter dAd, object transaccion)
        {
            DataSet dSet = new DataSet();
            try
            {
                dAd.SelectCommand.Transaction = (NpgsqlTransaction)transaccion;
                dAd.Fill(dSet);
                return dSet;
            }
            catch (Exception ex)
        ...
        private static DataTable FillDataTable(NpgsqlDataAdapter dAd)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        private static DataTable FillDataTable(NpgsqlDataAdapter dAd, object transaccion)
        {
            DataTable dt = new DataTable();
            try
            {
