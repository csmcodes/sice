...
namespace Packages.AutorizacionComprobantesProduccion
{
    using System;
    ...
    public partial class AutorizacionComprobantesOfflineService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            this.Url = global::Packages.Properties.Settings.Default.Packages_AutorizacionComprobantesProduccion_AutorizacionComprobantesOfflineService;
        ...
        {
            return this.Invoke("autorizacionComprobante", new object[] { claveAccesoComprobante });
